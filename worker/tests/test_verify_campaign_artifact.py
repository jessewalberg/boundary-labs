...
class VerifyCampaignArtifactTest(unittest.TestCase):
    ...
    def test_rejects_partial_eval_coverage(self) -> None:
        ...
        self.assertIn("summary.total must be 4, got 1", errors)
        self.assertIn("results must contain 4 cases, got 1", errors)
    ...
    def test_rejects_summary_counts_that_do_not_sum_to_total(self) -> None:
        ...
        self.assertIn("summary pass/fail/partial/invalid counts must sum to total 4, got 1", errors)
...
def write_artifact(
    *,
    ...
    summary = {"total": total, "pass": total, "fail": 0, "partial": 0, "invalid": 0}
